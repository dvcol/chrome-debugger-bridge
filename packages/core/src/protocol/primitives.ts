...
export const sessionIdSchemaDefinition = z.uuid();
...
export const sessionIdSchema = exposeProtocolSchema(sessionIdSchemaDefinition);
...
export type SessionId = ProtocolSchemaOutput<typeof sessionIdSchema>;
