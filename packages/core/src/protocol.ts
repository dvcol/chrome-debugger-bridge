...
export {
  ...
  type CdpEvent,
  cdpEventSchema,
  type CdpSubscriptionBatch,
  cdpSubscriptionBatchSchema,
  type CdpSubscriptionOverflow,
  cdpSubscriptionOverflowSchema,
  type CdpSubscriptionPredicate,
  cdpSubscriptionPredicateSchema,
