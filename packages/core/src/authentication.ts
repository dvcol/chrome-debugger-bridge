export const agentAuthenticationProtocol = 'chrome-debugger-bridge.agent.v1';
...
export interface AgentAuthenticationTranscript {
  ...
  /** Separate authentication transcripts for transports sharing a pairing credential. */
...
function createBaseAuthenticationTranscript(transcript: AgentAuthenticationTranscript): readonly unknown[] {
  return [
    ...
    transcript.transportProtocol ?? agentAuthenticationProtocol,
    'agent',
